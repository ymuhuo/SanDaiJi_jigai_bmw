...
public class UrlUtil {
    ...
    private final static String local_video_path = "/bominwell/dinosaur_data/video/";
    private final static String local_picture_path = "/bominwell/dinosaur_data/capture/";
