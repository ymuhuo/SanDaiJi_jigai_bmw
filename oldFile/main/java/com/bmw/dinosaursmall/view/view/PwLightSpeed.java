...
public class PwLightSpeed {
    ...
    public void setLightWhich(Model_info model_info){
        if(isSpeedModel)
            return;
        if (model_info.toString().contains("video_four")) {
            foward_line.setVisibility(View.VISIBLE);
            back_line.setVisibility(View.VISIBLE);
            ptz_line.setVisibility(View.VISIBLE);
        }
        if (model_info.toString().contains("front")) {
            foward_line.setVisibility(View.VISIBLE);
        }
        if (model_info.toString().contains("rear")) {
            back_line.setVisibility(View.VISIBLE);
        }
        if (model_info.toString().contains("ptz") || model_info.toString().contains("ir")) {
            ptz_line.setVisibility(View.VISIBLE);
        }
    }
