...
public class VerticalPageSeekBar extends SeekBar {
    ...
    private OnSeekBarStopTouchListener listener;
    ...
    public interface OnSeekBarStopTouchListener{
        void setSeekBarChanged(int progress,int id);
    }

    public void setOnSeekBarStopTouchListener(OnSeekBarStopTouchListener listener){
        this.listener = listener;
    }
    //注册接口
    public void setSeekBarPageChangeListener(OnSeekBarChangeListener listener) {
    ...
    public boolean onTouchEvent(MotionEvent event) {
        ...
        switch (event.getAction()) {
            ...
            case MotionEvent.ACTION_UP:
                ...
                setProgress(j);
                onSizeChanged(getWidth(), getHeight(), 0, 0);
                listener.setSeekBarChanged(j,getId());
                break;
